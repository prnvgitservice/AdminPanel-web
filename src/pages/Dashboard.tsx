...
import { getCategorydetailsDashboard, getMonthlyBookingsDashboard, getRecentBookingsDashboard, getStatsDashboard, getRecentGuestBookingDashboard, getRecentGetInTouchDashboard } from '../api/apiMethods';
