...
import { Phone, User, Calendar, AlertCircle, Search, Mail } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="flex items-center gap-3 space-x-3 mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setOffset(1); // Reset offset to 1 when limit changes
                  }}
        ...
        <div className="mt-8">
          <p className="text-sm text-gray-600">
            Showing {filteredContacts.length} of {total} contacts • Page {offset} • {limit} per page
          </p>
        </div>
      </div>
    </div>
