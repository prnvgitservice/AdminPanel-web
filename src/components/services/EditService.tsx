...
import { updateServiceControlByCateId } from "../../api/apiMethods"; // Adjust the import path as needed
...
const EditService: React.FC = () => {
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(
    service?.image && typeof service.image === "string" ? service.image : null
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append("serviceId", formData.id);
      payload.append("serviceName", formData.name);
      payload.append("servicePrice", formData.price);
      ...
      await updateServiceControlByCateId(payload);
