...
const AdminUsers: React.FC<UsersProps> = ({ onAddUser }) => {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div>
                ...
                >
                  ...
                  {allUsers.map(user => (
                    <option key={user.id} value={user.AdminUser}>
                      {user.AdminUser}
                    </option>
                  ))}
                </select>
                  ...
                  <tr key={user.id} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <img 
                          src={user.avatar} 
                          alt={user.AdminUsersName}
                          className="h-10 w-10 rounded-full object-cover mr-3 shadow-sm"
                        />
                        <span className="text-sm font-medium text-gray-900">{user.AdminUsersName}</span>
                      </div>
                    </td>
